...
class MenuController extends Controller
{
    ...
    public function actionView($id)
    {
        ...
        $jumlahSubmenu = Menu::find()->where(["parent" => $id])->count();
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if ($model->parent == "") $model->parent = "0";

            $menu = Menu::find()->select("max(no_urut)+1 as no_urut")
                ->where(["parent" => $model->parent])->one();
